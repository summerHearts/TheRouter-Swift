...
public class TheRouterBApi: CustomRouterInfo {
    ...
    public static var routerClass = "TheRouterSwift_Example.TheRouterControllerB"
    public var params: [String: Any] { return [:] }
    public var jumpType: LAJumpType = .push
...
public class TheRouterCApi: CustomRouterInfo {
    ...
    public static var routerClass = "TheRouterSwift_Example.TheRouterControllerC"
...
public class TheRouterDApi: CustomRouterInfo {
    ...
    public static var routerClass = "TheRouterSwift_Example.TheRouterControllerD"
    public var params: [String: Any] { return [:] }
    public var jumpType: LAJumpType = .push
...
public class TheRouterWebApi: CustomRouterInfo {
    ...
    public static var routerClass = "TheRouterSwift_Example.TheRouterWebController"
    public var params: [String: Any] { return [:] }
    public var jumpType: LAJumpType = .push
